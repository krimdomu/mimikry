...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('opendcm_partition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mountpoint', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('fstype', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('ondisk', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('size', self.gf('django.db.models.fields.IntegerField')()),
            ('primary', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(related_name='paritions', to=orm['opendcm.System'])),
        ))
        db.send_create_signal('opendcm', ['Partition'])


    def backwards(self, orm):
        # Deleting model 'Partition'
        db.delete_table('opendcm_partition')
