...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.boot_device'
        db.add_column('opendcm_profile', 'boot_device',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ethernetcard', unique=True, null=True, to=orm['opendcm.EthernetCard']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.boot_device'
        db.delete_column('opendcm_profile', 'boot_device_id')
