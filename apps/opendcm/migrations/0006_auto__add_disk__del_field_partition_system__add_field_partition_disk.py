...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Disk'
        db.create_table('opendcm_disk', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('size', self.gf('django.db.models.fields.IntegerField')()),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disks', to=orm['opendcm.System'])),
        ))
        db.send_create_signal('opendcm', ['Disk'])

        # Deleting field 'Partition.system'
        db.delete_column('opendcm_partition', 'system_id')

        # Adding field 'Partition.disk'
        db.add_column('opendcm_partition', 'disk',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='partitions', null=True, to=orm['opendcm.Disk']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Disk'
        db.delete_table('opendcm_disk')


        # User chose to not deal with backwards NULL issues for 'Partition.system'
        raise RuntimeError("Cannot reverse this migration. 'Partition.system' and its values cannot be restored.")
        # Deleting field 'Partition.disk'
        db.delete_column('opendcm_partition', 'disk_id')
    ...
    models = {
        ...
        'opendcm.disk': {
            ...
            'system': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'disks'", 'to': "orm['opendcm.System']"})
        },
        ...
        'opendcm.partition': {
            ...
            'disk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'partitions'", 'null': 'True', 'to': "orm['opendcm.Disk']"}),
        ...
        'opendcm.profile': {
            ...
            'boot_device': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ethernetcard'", 'unique': 'True', 'null': 'True', 'to': "orm['opendcm.EthernetCard']"}),
