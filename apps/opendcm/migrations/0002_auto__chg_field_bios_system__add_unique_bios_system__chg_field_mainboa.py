...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bios.system'
        db.alter_column('opendcm_bios', 'system_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['opendcm.System']))
        # Adding unique constraint on 'Bios', fields ['system']
        db.create_unique('opendcm_bios', ['system_id'])


        # Changing field 'Mainboard.system'
        db.alter_column('opendcm_mainboard', 'system_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['opendcm.System']))
        # Adding unique constraint on 'Mainboard', fields ['system']
        db.create_unique('opendcm_mainboard', ['system_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Mainboard', fields ['system']
        db.delete_unique('opendcm_mainboard', ['system_id'])

        # Removing unique constraint on 'Bios', fields ['system']
        db.delete_unique('opendcm_bios', ['system_id'])


        # Changing field 'Bios.system'
        db.alter_column('opendcm_bios', 'system_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opendcm.System']))

        # Changing field 'Mainboard.system'
        db.alter_column('opendcm_mainboard', 'system_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opendcm.System']))
